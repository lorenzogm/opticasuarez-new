      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="w-16 h-16 bg-gradient-to-br from-purple-600 via-pink-600 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
            ...
            <Button variant="primary" href={instagram.url} className="w-full">
              Seguir
            </Button>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <Button variant="primary" href={facebook.url} className="w-full">
              Seguir
            </Button>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <Button variant="primary" href={youtube.url} className="w-full">
              Suscribirse
            </Button>
          </div>
        </div>
