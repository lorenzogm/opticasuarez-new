    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center mt-4">
            ...
            <p className="text-gray-600 mt-2">
              Tipo de cita: <span className="font-medium">{appointmentTypes[appointmentType as keyof typeof appointmentTypes]}</span>
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Date Selection */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Fechas disponibles</h3>
            <div className="grid grid-cols-1 gap-2 max-h-96 overflow-y-auto">
              {availableDates.map((date, index) => (
                ...
                >
                  ...
                  <div className="text-sm text-gray-600 capitalize">{formatDate(date)}</div>
                </button>
              ))}
            </div>
          </div>
